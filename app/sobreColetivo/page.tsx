				...
				<div className="bg-cinza p-7 min-h-screen">
					...
					<div className="bg-preto p-7 flex flex-col gap-5 mt-4">
						<div className="flex flex-col gap-5">
							...
							<Divider/>
							<p className="text-md md:text-xl text-branco">A atual coordenação do Coletivo Casulo, reorganizada em 2024, conta com as/os seguintes educadoras/es e ativistas na coordenação dos seus projetos de formação e de educação popular:</p>
						</div>
