...
export default function Minicurso() {
  return (
    <>
      <Header />
      <div className="flex flex-col justify-center items-center p-10 bg-preto gap-10">
        <div className="flex items-center flex-col gap-10">
          <h1 className="text-4xl text-branco text-center">“Paulo Freire e a nossa escola: prática educativa e realidade educacional”</h1>
          <Divider/>
        </div>
