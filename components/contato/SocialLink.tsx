...
export default function SocialLink({ href, platform }: SocialLinkProps) {
  return (
    <a href={href} target="_blank" rel="noreferrer noopener">
      <div className="w-32 aspect-square flex gap-1 p-5 items-center flex-col justify-between bg-cinza shadow-md rounded-lg hover:translate-y-1 transition-all">
        {icons[platform]}<br />
